...
final class AppShadows extends ThemeExtension<AppShadows> {
  ...
  static final light = AppShadows(
    xs: [BoxShadow(color: Color.fromRGBO(10, 13, 20, 0.04), blurRadius: 2.r, spreadRadius: 0, offset: Offset(0, 1.h))],
    md: [
      BoxShadow(
  ...
  AppShadows lerp(ThemeExtension<AppShadows>? other, double t) {
    ...
    return AppShadows(xs: BoxShadow.lerpList(xs, other.xs, t)!, md: BoxShadow.lerpList(md, other.md, t));
  }
}
